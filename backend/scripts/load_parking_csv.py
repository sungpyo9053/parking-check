...
COLUMN_CANDIDATES = {
    ...
    "road_address": ["소재지도로명주소", "ROAD_NM_ADDR", "RDNMADR", "rdnmadr"],
    "jibun_address": ["소재지지번주소", "LNM_ADDR", "LNMADR", "lnmadr"],
    "lat": ["위도", "LAT", "LATITUDE", "latitude"],
    "lng": ["경도", "LOT", "LNG", "LONGITUDE", "longitude"],
    "capacity": ["주차구획수", "PRK_CMPRT_CO", "PRKCMPRT", "prkcmprt"],
    "weekday_open_time": [
        "평일운영시작시각",
        "WD_OPER_BGNG_TM",
    ...
    "fee_type": ["요금정보", "PRK_TYPE", "PARKINGCHRGE_INFO", "parkingchrgeInfo"],
    "base_time": ["주차기본시간", "BSC_PRK_HM", "BASIC_TIME", "basicTime"],
    "base_fee": ["주차기본요금", "BSC_PRK_CRG", "BASIC_CHARGE", "basicCharge"],
    "extra_time": ["추가단위시간", "ADD_UNIT_TM", "ADD_UNIT_TIME", "addUnitTime"],
    "extra_fee": ["추가단위요금", "ADD_UNIT_CRG", "ADD_UNIT_CHARGE", "addUnitCharge"],
    "phone": ["전화번호", "TELNO", "PHONE_NUMBER", "phoneNumber"],
    ...
    "data_reference_date": ["데이터기준일자", "REFER_DE", "REFERENCE_DATE", "referenceDate"],
}
